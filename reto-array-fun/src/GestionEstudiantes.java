public class GestionEstudiantes {
    ...
    public static void encontrarMejorMateria(String[] materias, double[][] notas) {
        ...
        for (int j = 0; j < materias.length; j++) {
            ...
            double promedioMateria = suma / notas.length;
            if (promedioMateria > mejorPromedioMateria) {
                mejorPromedioMateria = promedioMateria;
                mejorMateriaIndex = j;
            }
        }
        System.out.println("La materia con el promedio más alto es " + materias[mejorMateriaIndex] + " con un promedio de " + mejorPromedioMateria);
    }
}
